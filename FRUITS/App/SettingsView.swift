            ...
            ScrollView(.vertical, showsIndicators: false){
                ...
                //MARK: - SECTION 2
                    ...
                    GroupBox(
                        ...
                        Divider().padding(.vertical, 4)
                        Text("If you wish, you can restart the application by toggle the switch in this box. That way it start onboarding process and you will see the welcome screen again.")
                            .padding(.vertical, 8)
                            .frame(minHeight: 60)
                            .layoutPriority(1)
                            .font(.footnote)
                ...
                //MARK: - SECTION 3
                    GroupBox(
                        ...
                        SettingsRowView(name: "Twitter", content: "@RobertPetras", linkDestination: "twitter.com/robertpetras")
